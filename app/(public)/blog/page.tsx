...
import { formatPublishedDate, handleSocialShare, sanitizeContent, slugify } from "@/helpers/utils";
                          ...
                          <ul className="social-share">
                            ...
                            <li>
                              <a
                                ...
                                target="_blank"
                                onClick={(e) => handleSocialShare(e, "facebook", `${window.location.origin}/blog/article/${slugify(
                                  post?.title
                                )}/${post?.id}`)}
                              >
                            ...
                            <li>
                              <a
                                ...
                                onClick={(e) => handleSocialShare(e, "twitter", `${window.location.origin}/blog/article/${slugify(
                                  post?.title
                                )}/${post?.id}`)}
                              >
                            ...
                            <li>
                              <a
                                ...
                                onClick={(e) => handleSocialShare(e, "linkedin", `${window.location.origin}/blog/article/${slugify(
                                  post?.title
                                )}/${post?.id}`)}
                              >
