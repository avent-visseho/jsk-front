      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntityOfPage: {
              "@type": "WebPage",
              "@id": `https://jsk-opinions.com/blog/article/${slugify(
                post?.title || ""
              )}/${post?.id}`,
            },
            headline: post?.title || "",
            ...
            publisher: {
              ...
              logo: {
                "@type": "ImageObject",
                url: "https://jsk-opinions.com/assets/imgs/jed/blogs/jed.png",
              },
            },
            description: cleanHtmlContent(post?.content || "", 260),
          }),
        }}
      />
    </>
